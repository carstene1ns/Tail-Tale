...
void  ChangeCharacter(TPuzzleTrial *class, int level)
{
  ...
  case 11:
    TGameScreen_LoadTexture(class->screen, 8, "chara01_3.png");
    break;
    
  case 16:
    TGameScreen_LoadTexture(class->screen, 8, "chara01_4.png");
    break;
    
  case 21:
    TGameScreen_LoadTexture(class->screen, 8, "chara01_5.png");
    break;
